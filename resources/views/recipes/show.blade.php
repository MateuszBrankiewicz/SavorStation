<x-app-layout>
    <style>
        ...
        .rate label:nth-child(even):before {
            content: "\f005";
            /* FontAwesome full-star */
            font-family: "FontAwesome";
        }
    </style>
    <div class="md:container md:mx-auto mt-12  space-y-12 md:max-w-6xl">
        <!-- Recipe Title -->
        <div class="flex flex-col justify-center items-center mx-auto sm:w-max text-center bg-gradient">
            <div class='p-8'>
            ...
            <img src="{{ asset('storage/' . $recipe->image_path) }}" alt="Recipe Image" class="md:w-full md:max-w-lg md:shadow-lg">
        </div>
    ...
    <!-- Comments Section -->
    <center>
        <div class="p-6 mb-2 w-1/2 rounded-lg shadow-lg bg-gradient">
            ...
            <div class="mt-6 space-y-4 flex flex-col">
                ...
                @else
                <span class="text-white text-center">Zalogj się aby móc skomentować przepis!</span>
                @endif
            </div>
        </div>
    </center>
